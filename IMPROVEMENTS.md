...
### 10. **Detection Filtering**
- Filter results by detection type (signature/stamp/QR)
...
- Combine detection with OCR
- Text extraction from signatures/stamps

### 29. **Comparison Mode**
- Compare multiple documents
- Diff view for detections
